...
APlayerCar::APlayerCar()
{
	...
	Vehicle4W->WheelSetups[0].BoneName = FName("WheelFrontLeft");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -12.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = FrontWheel;
	Vehicle4W->WheelSetups[1].BoneName = FName("WheelFrontRight");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 12.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = RearWheel;
	Vehicle4W->WheelSetups[2].BoneName = FName("WheelRearLeft");
